          ...
          <CCardBody>
            <div className="row">
              ...
              <div className="col" style = {{textAllign: "left"}}>
                <div className="mb-3"><label className="form-label" htmlFor="province"><strong>ID MCP</strong>: 1</label></div>
                <div className="mb-3"><label className="form-label" htmlFor="province"><strong>Sức chứa</strong>: 1,8 tấn</label></div>
                <div className="mb-3"><label className="form-label" htmlFor="province"><strong>Tình trạng</strong>: 50%</label></div>
                <div className="mb-3"><label className="form-label" htmlFor="province"><strong>Người quản lý</strong>: Tus đẹp trai</label></div>
                <div className="mb-3"><label className="form-label" htmlFor="province"><strong>Thuộc tuyến đường</strong>: 1</label></div>
              </div>
            </div>
          </CCardBody>
        </CCard>
